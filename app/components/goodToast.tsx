...
export default function GoodToast() {
    return (
        <div id="toast-simple"
            ...
            <div className="hidden md:block pl-4 text-sm font-normal">Message sent successfully.</div>
            <div className="md:hidden pl-4 text-sm font-normal">Success.</div>
        </div>
    );
}
