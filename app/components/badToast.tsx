...
export default function BadToast() {
    return (
        <div id="toast-simple"
            ...
            <div className="hidden md:block pl-4 text-sm font-normal">Message failed to send.</div>
            <div className="md:hidden pl-4 text-sm font-normal">Failed to send.</div>
        </div>
    );
}
