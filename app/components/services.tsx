                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-col md:flex-row justify-around w-full px-4 md:px-20'>
                        <div className='flex flex-col items-center justify-center w-full md:w-1/4 h-2/3'>
                            ...
                            <p className='text-white text-xl text-center'>code free web design</p>
                            <p className='text-white text-md text-center md:p-5'> Platforms like WordPress, Wix, and Shopify offer affordable and user-friendly 
                        ...
                        <div className='flex flex-col items-center justify-center w-full md:w-1/4 h-2/3'>
                            ...
                            <p className='text-white text-xl text-center'>app development</p>
                        ...
                        <div className='flex flex-col items-center justify-center w-full md:w-1/4 h-2/3'>
                            ...
                            <p className='text-white text-xl text-center'>bespoke coded sites</p>
                        ...
                        <div className='flex flex-col items-center justify-center w-full md:w-1/4 h-2/3'>
                            ...
                            <p className='text-white text-xl text-center'>AI assisted workflows</p>
